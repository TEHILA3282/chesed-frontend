...
export class FreezeRequestComponent implements OnInit {
  ...
  ackText = computed(() =>
    this.type() === 'deposit'
      ? 'בקשה זו נשלחה 3 ימים קודם יום החיוב. ובאם לא, הרי שאין הקופה אחראית לבקשה זו היות והקפאת שלומים מבוצעים עד 3 ימים ממועד התשלום. (במקרה ונוכל לממש את הבקשה נודיע על כך בהודעה חוזרת)'
